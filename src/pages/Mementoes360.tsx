          ...
          <motion.div style={{ opacity: textOpacity }} className="max-w-5xl">
            ...
            >
              <p className="text-lg md:text-2xl text-gray-300 font-light max-w-xl leading-relaxed">
                Community development, skills training, and building the next generation of South African workers.
              </p>
              ...
              <div className="space-y-8 text-left">
                <div className="bg-white p-8 md:p-10 shadow-[0_30px_60px_rgba(0,0,0,0.05)] border-l-[12px] border-primary relative overflow-hidden group rounded-2xl">
                  ...
                  <p className="text-xl md:text-2xl text-primary font-bold uppercase tracking-tighter leading-tight mb-6 italic">
                    "Training the next generation of skilled workers in Ga-Nala through hands-on technical education."
                  </p>
                  <p className="text-gray-500 font-light leading-relaxed mb-8">
                    The Mementoes 2026 Bursary Program was created to close the local skills gap. We provide full funding and support for young people training in Plumbing, Electrical Engineering, and Civil Engineering — building the workforce South Africa needs.
                  </p>
        ...
        <div className="container mx-auto px-6 lg:px-16 relative z-10">
          <div className="flex flex-col items-center mb-24 text-center">
            <div className="flex items-center gap-4 mb-6">
              ...
              <span className="text-secondary font-black text-[10px] tracking-[0.5em] uppercase">A New Look</span>
              <div className="w-12 h-[1px] bg-secondary" />
            </div>
            ...
            <div className="lg:col-span-5 space-y-16">
              ...
              <div className="pt-8 border-t border-white/10 text-left">
                <p className="text-xl text-white/40 font-light italic leading-relaxed text-left">
                  "Our new look reflects where we're headed — steady growth, sustainability, and doing more across the industries we serve."
                </p>
              </div>
            </div>
          </div>
